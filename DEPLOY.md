# Deploying Rock Steady Boxing Lake Balboa
...
2. Enter `rocksteadyboxinglakebalboa.com` → **Verify** → **Add domain**.
...
- Set `https://rocksteadyboxinglakebalboa.com` as the primary domain so
